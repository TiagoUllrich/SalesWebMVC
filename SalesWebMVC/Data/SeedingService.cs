...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "mariagreen@gmail.com", new DateTime(1979, 2, 12), 2000.0, d2);
            Seller s3 = new Seller(3, "Alex Grev", "alexgrev@gmail.com", new DateTime(1988, 1, 15), 1900.0, d3);
            Seller s4 = new Seller(4, "Martha Ruberts", "martharuberts@gmail.com", new DateTime(1993, 11, 30), 2300.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donaldblue@gmail.com", new DateTime(2000, 1, 9), 1800.0, d3);
